  ...
  <div class="sa-account-auth__grid<?php echo ('yes' === get_option('woocommerce_enable_myaccount_registration')) ? ' sa-account-auth__grid--2' : ''; ?>">
    ...
    <section class="sa-account-auth__panel sa-account-auth__login">
      <header class="sa-account-panel__head">
        ...
        <p class="sa-account-panel__lead"><?php esc_html_e('Access orders, invoices, and your saved cart on any device.', 'supreme-autoparts'); ?></p>
      </header>
      ...
      <form class="woocommerce-form woocommerce-form-login login sa-form" method="post" novalidate>
        ...
        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
          <label for="username"><?php esc_html_e('Username or email address', 'supreme-autoparts'); ?>&nbsp;<span class="required">*</span></label>
    ...
    <?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
      <section class="sa-account-auth__panel sa-account-auth__register">
        <header class="sa-account-panel__head">
          ...
          <p class="sa-account-panel__lead"><?php esc_html_e('Save your cart and track orders across phones and laptops.', 'supreme-autoparts'); ?></p>
        </header>
