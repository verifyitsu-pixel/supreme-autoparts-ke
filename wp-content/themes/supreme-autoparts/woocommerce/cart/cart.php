    ...
    <tbody>
      ...
      <tr>
        <td colspan="6" class="actions">
          <button type="submit" class="button" name="update_cart" value="<?php esc_attr_e('Update cart', 'supreme-autoparts'); ?>"><?php esc_html_e('Update cart', 'supreme-autoparts'); ?></button>
